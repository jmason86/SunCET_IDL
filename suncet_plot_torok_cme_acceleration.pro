;+
; NAME:
;   SunCET_plot_torok_cme_acceleration
;
; PURPOSE:
;   Read in data from the Toeroek figure and replot as normalized acceleration vs radial distance in Rs.
;   Key component of the SunCET "one liner" figure
;
; INPUTS:
...
;-
PRO SunCET_plot_torok_cme_acceleration, DARK_BACKGORUND = DARK_BACKGROUND
